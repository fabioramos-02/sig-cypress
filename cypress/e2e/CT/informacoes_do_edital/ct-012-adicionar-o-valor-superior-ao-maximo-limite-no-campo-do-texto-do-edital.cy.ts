...
describe('Adicionar texto com quantidade de caracteres igual ao valor máximo no campo do Texto do Edital', () => {
    beforeEach(() => {
    ...
    it('Deve permitir que o usuário insira o valor máximo permitido no campo "Texto do Edital"', () => {
        ...
        cy.preencherTextoDoEdital(textoTextoDoEdital); // Preenche o Texto do Edital com o texto máximo
