...
describe('Adicionar o valor máximo no campo do Texto do Edital', () => {
    beforeEach(() => {
        // Realiza login no sistema antes de cada teste
        cy.login(0); // Realiza login como Gestor (índice 0)
    });

    it('Deve permitir que o usuário insira o valor máximo permitido no campo "Texto do Edital"', () => {
        ...
        cy.get('.css-y8ykzc > .MuiTypography-root')
            .eq(0)
            .should('contain.text', 'Abrangência');  // Verifica se a aba 'Termo de Aceite' está visível
    ...
    const preencherTextoDoEditalComValorMaximo = () => {
        ...
        // Gerar Lorem Ipsum com 5000 caracteres (o limite máximo permitido)
        const textoTextoDoEdital = gerarLoremIpsum(5000);  // Gera o texto com 5000 caracteres
