describe('Validar Aparição do Nível de Bolsa ao selecionar uma Modalidade', () => {
  ...
  it('Deve exibir o campo Nível de Bolsa ao selecionar uma Modalidade', () => {
    ...
    cy.get('[data-cy="bolsaEdital-confirmar"]').click(); // Clica no botão Confirmar para aplicar a seleção
